...
- **四路徑跳轉引擎**: 獨家 Multi-Hop 技術，自動透過 USD/TWD 中轉解決資料空白問題，確保換算絕不失誤。
...
- **Frontend**: React 18, Recharts, Lucide Icons, Tailwind CSS (Vanilla Integration)
- **Backend**: Node.js Express, PostgreSQL (Data Persistence)
- **Data Pipeline**: Python Scrapers (YFinance, Real Estate Crawlers)
- **DevOps**: Docker, Docker Compose (Containerized Architecture)
...
```bash
# 克隆專案
git clone https://github.com/your-username/MetaMarket-Intelligence.git
